...
class _MoviePlayerScreenState extends State<MoviePlayerScreen> {
  ...
  Widget build(BuildContext context) {
    var dropdownButton7 = DropdownButton<String>(
      ...
      dropdownColor: Colors.black54, // Negro más claro
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.black54, // Negro más claro para la barra superior
      ),
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Colors.black54, Colors.grey], // Fondo negro más claro
          ),
        ),
        child: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: Colors.black54, // Negro más claro para el botón
